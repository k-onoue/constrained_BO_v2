...
# argparseの設定
parser = argparse.ArgumentParser(description='Run Tensor Train decomposition benchmark with specified logical cores and rank.')
...
# ログファイルの設定
logfile_name = f"benchmark_log_cores_{logical_cores}_rank{rank_index}_tt.log"
